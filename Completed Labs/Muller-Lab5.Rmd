...
output:
  html_document:
    css: C:\Users\Exped\Documents\R\win-library\3.3\DATA606\labs\Lab5\lab.css
    highlight: pygments
    theme: cerulean
...
load("C:/Users/Exped/Documents/R/win-library/3.3/DATA606/labs/Lab5/more/nc.RData")
```
...
### 1000 Observations in this data set.
...
```
### Sample sizes are large enough to use the normal distribution in hypothesis testing.  
...
### I would use the median age to find cutoff.
...
### I tested whether or not the average weight of a mother was dependent on her marital status. The probability that it was independent was 0 (p-value). Which means we were in favor of the alternative hypothesis, and the average is dependent.  
<div id="license">
